# Generated by Django 3.2 on 2023-10-21 17:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[(reviews.models.RoleEnum['user'], 'user'), (reviews.models.RoleEnum['moderator'], 'moderator'), (reviews.models.RoleEnum['admin'], 'admin')], default='user', max_length=9, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(null=True, verbose_name='Рейтинг на основе отзывов')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(error_messages={'validators': 'Значение больше 10'}, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(_negated=True, username='me'), name='username_can_not_be_me'),
        ),
    ]
